...
tf.flags.DEFINE_string("train_data_file", "./data/personality_essay.csv", "Data source for the positive data.")
tf.flags.DEFINE_string("fb_data_file", "./data/personality_input.csv", "Data source for the fb data.")
